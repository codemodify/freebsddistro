...
menu::menu(QWidget *parent) : QPushButton(parent)
{
	...
	QImage img;//(WindowManager::get_cfile("menu.xpm"));
...
{
	QString fname ;//= WindowManager::get_cfile("menuconfig");
...
{/*	
	...
	if(! defaults::show_menu || WindowManager::smode)  // show at mouse position
	{
