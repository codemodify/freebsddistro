...
static int qcf[] = { WindowManager::Sticky,WindowManager::WindowListSkip,WindowManager::SmallFrame,WindowManager::NoResize,
WindowManager::NoTile,WindowManager::NoKey,WindowManager::NoScreen,WindowManager::ClassOnly };
