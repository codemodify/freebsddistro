...
%description -l fr
FVWM est un gestionnaire de fenЙtres puissant et extrЙmement configurable
pour le systХme X Window.

La version 2.4 contient un grand nombre de nouvelles fonctionnalitИs.
...
amИlioration des modules ainsi que de nouveaux modules,
le code pour les menus a ИtИ entiХrement refondu, 
les mouvements de souris peuvent Йtre liИs Ю des actions (stroke).
